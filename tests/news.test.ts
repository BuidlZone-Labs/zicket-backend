...
describe('NewsroomService', () => {
    describe('createNews', () => {
        ...
        it('should set imageUrl when a direct URL is supplied', async () => {
            ...
            jest.spyOn(News.prototype, 'save').mockImplementationOnce(function (this: any) {
                savedData = this;
        ...
        it('should propagate database errors', async () => {
            jest.spyOn(News.prototype, 'save').mockRejectedValueOnce(new Error('DB error'));

            await expect(
                NewsroomService.createNews(validPayload),
...
describe('POST /news', () => {
    ...
    it('should return 500 on unexpected service errors', async () => {
        jest.spyOn(News.prototype, 'save').mockRejectedValueOnce(new Error('Unexpected DB failure'));
